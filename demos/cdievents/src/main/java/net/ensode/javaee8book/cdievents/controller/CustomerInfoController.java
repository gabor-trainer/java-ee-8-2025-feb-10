...
import net.ensode.javaee8book.cdievents.eventlistener.NavigationEventListener;
...
public class CustomerInfoController implements Serializable {
    ...
    //    @Inject
    //    NavigationEventListener handler;
    ...
    public String customerInfoEntry() {
        ...
        // handler.handleNavigationEvent(navigationInfo);
        return "page1";
    }
